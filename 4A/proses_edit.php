  ...
  if($gambar_buku != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  move_uploaded_file($file_tmp, 'gambar/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                    ...
                    // jalankan query UPDATE berdasarkan ID yang bukunya kita edit
                   $query  = "UPDATE buku SET judul = '$judul', deskripsi = '$deskripsi', harga_beli = '$harga_beli', stok = '$stok', gambar_buku = '$nama_gambar_baru'";
                    $query .= "WHERE id = '$id'";
      ...
      // jalankan query UPDATE berdasarkan ID yang bukunya kita edit
      $query  = "UPDATE buku SET judul = '$judul', deskripsi = '$deskripsi', harga_beli = '$harga_beli', stok = '$stok'";
      $query .= "WHERE id = '$id'";
      $result = mysqli_query($koneksi, $query);
      // periska query apakah ada error
      if(!$result){
