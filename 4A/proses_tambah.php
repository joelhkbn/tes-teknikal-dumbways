  ...
  $nama_gambar_baru = $angka_acak.'-'.$gambar_buku; //menggabungkan angka acak dengan nama file sebenarnya
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {     
                move_uploaded_file($file_tmp, 'gambar/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                  ...
                  $query = "INSERT INTO tb_perpustakaan (judul, deskripsi, category_id, stok, gambar_buku) VALUES ('$judul', '$deskripsi', '$category_id', '$stok', '$nama_gambar_baru')";
   ...
   $query = "INSERT INTO buku (judul, deskripsi, category_id, stok, gambar_buku) VALUES ('$judul', '$deskripsi', '$category_id', '$stok', null)";
                  $result = mysqli_query($koneksi, $query);
